...
namespace SpecFlowProject1.Support.POM.Locators
{
    internal class CartPageLoc
    {
        ...
        //span[@id]//span[@class='price' or 'price special-price']
        ...
        internal static By nameOfLastProduct = By.XPath("(//p[@class='product-name']/a)[1]");//psd
        internal static By nameOfFirstProduct = By.XPath("(//p[@class='product-name']/a)[2]");//blouse
